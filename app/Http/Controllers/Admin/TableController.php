...
class TableController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'admin.pages.tables.index', compact('tables')
        );
    }
    ...
    public function show($id)
    {
        ...
        return view(
            'admin.pages.tables.show', compact('table')
        );
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            'admin.pages.tables.edit', compact('table')
        );
    }
    ...
    public function qrcode($identify)
    {
        ...
        return view(
            'admin.pages.tables.qrcode', compact('uri')
        );
    }
}
