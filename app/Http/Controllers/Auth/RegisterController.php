...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        if (!$plan = session('plan')) { // recupera o plano da session
        ...
        // chama o evento, que por sua vez será ouvido pelo listener 'AddRoleTenant'
        // depois de criado um Tenant, dispara o evento para que
        // o listener crie um cargo para esse Tenant recem adicionado
